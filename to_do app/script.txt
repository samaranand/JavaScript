...
var UIController = (function(){
    ...
    return {
        ...
        addItem: function(data){
            id += 1;
            var v = '<li id="list-%id%"><div id="list-%id%-value">%data%<button class="list-bin-button" type="button"><i class="fas fa-trash-alt"></i></button></div></li>';
           //type="button"
            v = v.replace('%id%',id);
            v = v.replace('%id%',id);
...
var controller = (function(UICtrl){
    ...
    var startFun = function(){
        ...
        document.querySelector('.container-box').addEventListener('keypress', function(e){
