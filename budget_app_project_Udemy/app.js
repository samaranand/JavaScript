  ...
  return {
    ...
    clearFields: function () {
      ...
      var f = document.querySelectorAll(
        DOMstring.inpValue + ", " + DOMstring.inpDes
      );
    ...
    displayBudget: function (obj) {
      ...
      document.querySelector(DOMstring.budgetValue).textContent = formatNum(
        obj.budget,
        type
      );
      document.querySelector(
        DOMstring.budgetIncomeValue
      ).textContent = formatNum(obj.income, "inc");
      document.querySelector(
        DOMstring.budgetExpensesValue
      ).textContent = formatNum(obj.expenses, "exp");
      if (obj.percentage > 0) {
    ...
    changeTheme: function () {
      var tmp = document.querySelectorAll(
        DOMstring.inpType + "," + DOMstring.inpDes + "," + DOMstring.inpValue
      );
...
var controller = (function (budgetCtrl, UICtrl) {
  var setUpEvent = function () {
    ...
    // delete button clock
    document
      .querySelector(inpDOM.container)
      .addEventListener("click", ctrlDltItem);

    // changing class with inc n exp
    document
      .querySelector(inpDOM.inpType)
